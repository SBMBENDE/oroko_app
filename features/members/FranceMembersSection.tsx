...
interface FranceMembersSectionProps {
  members: Member[];
}

export function FranceMembersSection({ members }: FranceMembersSectionProps) {
  const [showAll, setShowAll] = useState(false);
  return (
    <Section>
      <SectionHeading
        title="Members"
        subtitle="Meet the 20 members driving OCA France forward."
        centered
      />
